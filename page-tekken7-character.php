...
/****************************************
  ...
  Template Name: page-tekken7-character
...
<div class="col-6 col-md-3 mb-3">
    <div class="card border-0 shadow custom-background">
        <a href="https://gamewidth.net/tekken7/about-<?php echo $value; ?>-tekken7/">
            <img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $value; ?>_thumbnail.png" alt="" width="100%" height="auto" />
        </a>
        <!-- スラッグページ名- about-character name-tekken7 -->
        <div class="card-body text-center">
            <a href="https://gamewidth.net/tekken7/about-<?php echo $value; ?>-tekken7/"><?php echo $value; ?></a>
        </div>
    </div>
</div>
