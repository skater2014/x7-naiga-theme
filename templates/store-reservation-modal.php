  ...
  <div class="store-reservation-modal-content">
    ...
    <div class="step active" id="step-input">
      ...
      <form id="store-reservation-form" action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="POST">
        ...
        <p class="attention">
          <span>※<a href="<?php echo esc_url(home_url('/terms/')); ?>" target="_blank">利用規約</a>及び<a href="<?php echo esc_url(home_url('/privacypolicy/')); ?>" target="_blank">プライバシーポリシー</a>を必ずお読みください。<br>
