 ...
 * Hero Slider データ
 * - 各スライドごとの文言を取得
 * - 2枚目以降未入力時は 1枚目 → 共通fallback → ページタイトル の順で補完
 * ========================================================= */
$hero_slides = array();
...
for ($i = 1; $i <= 20; $i++) {
    ...
    $slide_title = $slide_title_raw !== ''
        ? $slide_title_raw
        : ($slide1_title !== '' ? $slide1_title : $page_title);
    ...
    $hero_slides[] = array(
        'image_id' => $image_id,
        'alt'      => $get_attachment_alt($image_id, $slide_title !== '' ? $slide_title : $page_title),
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="room-hero-overlay">
                                    <div class="room-hero-copy">
                                        ...
                                        <h1 class="room-hero-title"><?php echo esc_html($slide['title'] !== '' ? $slide['title'] : $page_title); ?></h1>
                ...
                <div class="room-hero-static">
                    ...
                    <div class="room-hero-overlay">
                        <div class="room-hero-copy">
                            ...
                            <h1 class="room-hero-title"><?php echo esc_html($page_title); ?></h1>
