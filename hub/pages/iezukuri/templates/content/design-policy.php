<?php
/**
 * hub/pages/iezukuri/templates/content/design-policy.php
 *
 * 役割:
 * - 設計姿勢 ページ専用の本文エリア
...
<section class="iez-sub-section iez-sub-section--design-policy" id="design-policy-content">
...
?>
<h2 class="iez-sub-section__title">設計姿勢</h2>
<?php endif; ?>
