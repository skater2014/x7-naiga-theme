<?php
/**
 * hub/pages/iezukuri/templates/content/design-office.php
 *
 * 役割:
 * - デザインと設計 ページ専用の本文エリア
...
<section class="iez-sub-section iez-sub-section--design-office" id="design-office-content">
...
?>
<h2 class="iez-sub-section__title">デザインと設計</h2>
<?php endif; ?>
