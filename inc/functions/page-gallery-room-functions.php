...
?>
    ...
    <p style="margin:0 0 16px;color:#646970;">
        各スライドごとに文言を設定できます。2枚目以降が未入力なら、1枚目 → 共通ヒーロー文言 の順で補完します。
    </p>
...
function rg_render_hero_text_metabox($post)
{
    ...
    $title   = get_post_meta($post->ID, '_rg_hero_title', true);
...
?>
    ...
    <div class="rg-hero-text-box">
        ...
        <p class="rg-hero-text-field">
            <label for="rg_hero_title">ヒーロータイトル</label>
            <input
                type="text"
                id="rg_hero_title"
                name="rg_hero_title"
...
function rg_save_room_gallery_metaboxes($post_id)
{
    ...
    $hero_fields = array(
        ...
        '_rg_hero_title'   => isset($_POST['rg_hero_title']) ? rg_clean_text($_POST['rg_hero_title']) : '',
