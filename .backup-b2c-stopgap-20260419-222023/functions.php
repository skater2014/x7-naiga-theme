...
function themebs_enqueue_styles()
{
     ...
     * - モーダル土台
     */
    if (file_exists(get_template_directory() . '/minpaku/common/css/minpaku.css')) {
        wp_enqueue_style(
            'minpaku',
            get_template_directory_uri() . '/minpaku/common/css/minpaku.css',
            array('theme-style'),
            naigai_asset_ver('/minpaku/common/css/minpaku.css')
        );
    }
     ...
     * 民泊アーカイブ専用CSS
     * ---------------------------------------------------------
     * /minpaku-stay/ 一覧ページだけ
     */
    if ((($is_minpaku_archive ?? false) || is_page_template('page-minpaku-b2c.php')) && file_exists(get_template_directory() . '/minpaku/common/css/minpaku-footer-nav.css')) {
        wp_enqueue_style(
            'minpaku-footer-nav-css',
            get_template_directory_uri() . '/minpaku/common/css/minpaku-footer-nav.css',
            array(),
            naigai_asset_ver('/minpaku/common/css/minpaku-footer-nav.css')
        );
    }
    if ($is_minpaku_archive && file_exists(get_template_directory() . '/minpaku/common/css/minpaku-archive.css')) {
        wp_enqueue_style(
            'minpaku-archive',
            get_template_directory_uri() . '/minpaku/common/css/minpaku-archive.css',
            array('minpaku'),
            naigai_asset_ver('/minpaku/common/css/minpaku-archive.css')
        );
    }
     ...
     *
     * 注意:
     * - 予約カードや checkout UI は booking css に分ける
     */
    if (($is_minpaku_single || (function_exists('mnpk_is_checkout_endpoint') && mnpk_is_checkout_endpoint())) && file_exists(get_template_directory() . '/minpaku/common/css/minpaku-single.css')) {
        wp_enqueue_style(
            'minpaku-single',
            get_template_directory_uri() . '/minpaku/common/css/minpaku-single.css',
            array('minpaku'),
            naigai_asset_ver('/minpaku/common/css/minpaku-single.css')
        );
    }
     ...
     * - 人数モーダル
     * - checkout 画面
     * - Stripe Payment Element の囲み
     *
     * 今回は booking css を使う
     */
    if (($is_minpaku_single || (function_exists('mnpk_is_checkout_endpoint') && mnpk_is_checkout_endpoint())) && file_exists(get_template_directory() . '/minpaku/common/css/minpaku-booking.css')) {
        wp_enqueue_style(
            'minpaku-booking',
            get_template_directory_uri() . '/minpaku/common/css/minpaku-booking.css',
            array('minpaku', 'minpaku-single'),
            naigai_asset_ver('/minpaku/common/css/minpaku-booking.css')
        );
    }
}
 ...
 * =========================================================
 */
require_once get_template_directory() . '/inc/functions/hub/functions-hub-loader.php';
...
// 管理画面の「民泊」メニューを出すファイル
require_once get_template_directory() . '/inc/functions/minpaku/common/functions-minpaku.php';

// 民泊運営サポートLP 固定ページ メタボックス
require_once get_template_directory() . '/inc/functions/minpaku/b2b/functions-page-minpaku-support.php';

// 民泊カスタム投稿 + メタボックス + 空き状況 + 料金計算 + 決済

// 民泊ポータル（アーカイブ導入文・FAQ・キャンペーン・専用メニュー）
require_once get_template_directory() . '/inc/functions/minpaku/common/functions-minpaku-archive-settings.php';

// 民泊 b2b 固定ページ　メタボックス
require_once get_template_directory() . '/inc/functions/minpaku/b2c/functions-page-minpaku-b2c.php';

// 固定ページ　6枚
// require_once get_template_directory() . '/inc/functions/functions-minpaku-layout-assets.php';

// checkoutページ呼び出し機能
require_once get_template_directory() . '/inc/functions/minpaku/common/functions-minpaku-checkout-endpoint.php';
